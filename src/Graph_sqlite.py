#!/usr/bin/python
#
# This file contains datastructures and procedures to query the xref database and
# Generate json files.
#
# The script takes following arguments when run from the cli:
'''
...
SQLITE_DB= os.environ.get('SQLITE_DB','/var/u/graph.db')
