...
var trace = [];
trace['sys_chdir'] = ['user_path_at_empty'];
trace['user_path_at_empty'] = ['getname_flags','filename_lookup'];
trace['filename_lookup'] = ['path_lookupat'];
trace['path_lookupat'] = ['complete_walk'];
trace['complete_walk'] = ['unlazy_walk'];
trace['unlazy_walk'] = ['legitimize_mnt'];
trace['legitimize_mnt'] = ['mntput_no_expire'];
trace['getname_flags'] = ['putname'];
